...
public class TableHandlerTest {
    ...
    public void testReserveTablesTakesInReservations(){
        ...
        assertTrue(tableHandler.reserveTables(reservationList));
    }
    ...
    public void testReservationsOfWrongTableSizeRejected1(){
        ...
        assertFalse(tableHandler.reserveTables(reservationList));
    }
    ...
    @Test
    public void testReservationsTooLongRejected(){
        TableHandler tableHandler = new TableHandler();
        tableHandler.addNewTable("T001", 6);
        tableHandler.addNewTable("T002", 4);
        tableHandler.addNewTable("T003", 2);
        ...
        ArrayList<Reservation> reservationList = new ArrayList<>();
        reservationList.add(new Reservation(6, new Customer("John Tan", 91234567)));
        reservationList.add(new Reservation(4, new Customer("Jane Lim", 91234568)));
        reservationList.add(new Reservation(2, new Customer("Jack Wong", 91234569)));
        reservationList.add(new Reservation(4, new Customer("Jill Sim", 91234570)));
        reservationList.add(new Reservation(4, new Customer("Jill Sim", 91234571)));
