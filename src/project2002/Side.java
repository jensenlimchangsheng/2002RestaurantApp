...
/**
 * Side subclass of Menu Item where it contains the attributes size to allow
 * customers to specify if they want to upsize.
 * 
 * @author Jiam Tzi Yu
 * @version 1.0
 * @since 2021-11-09
...
public class Side extends MenuItem {
	...
	/**
	 * Creating a sude with name, price, itemType, and description extending menu
	 * item class
	 * 
	 * @param name
	 * @param price
