...
public class MenuHandler extends Handler {
	...
	//no need feed itemID -> auto generated base on what kind of item you want to add
	...
	//update fooditem by inputting its ID
	...
	public void printMenu(){
		...
		for(int i = 0; i < MenuItems.size(); i++) {
			...
			System.out.println(eachItem.getID() + " | " + eachItem.getItemType() + " | " + eachItem.getName() + " | $" + eachItem.getPrice() + " | " + eachItem.getDescription());
		}
		System.out.println("==================================================================");
	}
