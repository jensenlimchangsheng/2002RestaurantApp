...
/**
 * Main subclass of Menu Item where it contains the attributes doneness to allow
 * customers to specify their doneness preference.
 * 
 * @author Tzi Yu
 * @version 1.0
 * @since 2021-11-09
...
public class MainDish extends MenuItem {
	...
	/**
	 * Creating a main with name, price, itemType, and description extending menu
	 * item class
	 * 
	 * @param name
	 * @param price
